...
from attn_utils import FeatureInjector, AnchorCache, QueryStore
    ...
    def __call__(
        ...
        **kwargs,
                ...
                noise_pred = self.unet(
                       latent_model_input,
                        ...
                        cross_attention_kwargs={'query_store': query_store, 
                                                ...
                                                'no_attn_q': no_attn_q,
                                                'no_attn_k': no_attn_k,
                                                'use_consistyle_adain': use_consistyle_adain,
                                                'use_consistyle_direct_injection': use_consistyle_direct_injection,
        ...
        if not output_type == "latent":
            ...
            # Offload UNet to CPU to free up VRAM for VAE
            self.unet.to("cpu")
            ...
            # Move UNet back to original device (if needed for further calls)
